...
<!-- PARAMETRES GENERAUX -->
<a href="javascript:void(0);" title="<?php _e('Click to open', 'send-pdf-for-contact-form-7'); ?>" alt="<?php _e('Click to open', 'send-pdf-for-contact-form-7'); ?>" onclick="toggle_visibility('params-general');" onfocus="this.blur()" style="text-decoration:none;">
<div style="background-color:#fafafa;padding: 12px 10px;border:1px solid #b5b5b5;" onmouseover="this.style.backgroundColor='rgba(132, 136, 56, 0.43)';" onmouseout="this.style.backgroundColor='#fafafa';">
    <span class="dashicons dashicons-arrow-down-alt" style="float: right;padding: 15px 5px 5px 5px;"></span>
    <h3 class="hndle"><span class="dashicons dashicons-dashboard"></span> <?php _e('General Settings', 'send-pdf-for-contact-form-7'); ?></h3>
</div>
</a>

<div id="params-general" onfocus="this.blur()" style="border: 1px solid #cccccc;text-decoration:none;display:none;">
        ...
        <table class="wp-list-table widefat fixed" cellspacing="0">
            <tbody id="the-list">
                ...
                <tr>
                    ...
                    <td>
                        <input type= "checkbox" name="wp_cf7pdf_settings[pdf-file-delete]" value="true" <?php if( isset($meta_values["pdf-file-delete"]) && $meta_values["pdf-file-delete"]=="true" ) { echo 'checked'; } ?>>
                    </td>
                </tr>
                <tr><td colspan="2"><hr /></td></tr>
                <tr>
        ...
        <!-- MISE EN PAGE -->
        <div style="background-color:#fafafa;padding: 12px 10px;border:1px solid #d6d6d6;">
        ...
        <div id="params-layout" onfocus="this.blur()" style="border: 1px solid #cccccc;text-decoration:none;display:block;">
        <div id="meta">
            <table class="wp-list-table widefat fixed" cellspacing="0">
                <tbody id="the-list">
                    <tr>
                    ...
                    <tr>
                        <td>
                             <?php _e('Enter a URL or upload an image.', 'send-pdf-for-contact-form-7'); ?></small><br /><br />
                        ...
                        <td align="center">
                            <?php if( isset($meta_values['image']) ) { echo '<img src="'.esc_url($meta_values['image']).'" width="250">'; } ?><br />
                            <?php 
